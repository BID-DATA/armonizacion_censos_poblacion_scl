...
gen region_c =.
replace region_c=1 if geo1_ht1982==011 
replace region_c=2 if geo1_ht1982==012
replace region_c=3 if geo1_ht1982==016
replace region_c=4 if geo1_ht1982==023
replace region_c=5 if geo1_ht1982==024 
replace region_c=6 if geo1_ht1982==035
replace region_c=7 if geo1_ht1982==047
replace region_c=8 if geo1_ht1982==048
replace region_c=9 if geo1_ht1982==059
