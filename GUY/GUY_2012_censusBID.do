...
************************************		
	...
	*********
	gen byte afro_ci = . 
	replace afro_ci = 1 if p14==1
	replace afro_ci = 0 if inrange(p14,2,8)
	
	*********
	*indi_ci*
	*********	
	gen byte ind_ci =. 
	replace ind_ci = 1 if p14==2
	replace ind_ci = 0 if inrange(p14,3,8) |  p14==1
	...
	******************
	gen byte GUY_dis_ci = .
	replace GUY_dis_ci = 1 if p21==1
	replace GUY_dis_ci = 0 if p21==2
...
**********************************************************	
	...
	*************
	...
	replace viviprop_ch=1 if h31==1 // owned/freehold
	replace viviprop_ch=0 if h31==2 | h31==3 | h31==4 | h31==5 | h31==6 | h31==7 // lease-hold, rented, squatted, rent-free 
	replace viviprop_ch=. if h31==6 | h31==7 | h31==8   /// none/not applicable, other, ns
