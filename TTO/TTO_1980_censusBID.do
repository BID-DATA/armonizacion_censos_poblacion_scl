...
include "../Base/base.do"
   ...
   gen region_c=.   
   replace region_c=1 if geo1_tt1980 == 1			/*Port of Spain*/
   replace region_c=2 if geo1_tt1980 == 2			/*San Fernando*/
   replace region_c=3 if geo1_tt1980 == 3			/*Arima*/
   replace region_c=4 if geo1_tt1980 == 13			/*Saint George*/
   replace region_c=5 if geo1_tt1980 == 14			/*Caroni*/
   replace region_c=6 if geo1_tt1980 == 15		    /*Nariva and Mayaro*/
   replace region_c=7 if geo1_tt1980 == 16			/*Saint Andrew and Saint David*/
   replace region_c=8 if geo1_tt1980 == 17			/*Victoria*/
   replace region_c=9 if geo1_tt1980 == 38			/*Saint Patrick*/
   replace region_c=10 if geo1_tt1980 == 39			/*Tobago*/
