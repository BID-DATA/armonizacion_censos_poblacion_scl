...
*****************************************************
    ...
    ****************
	gen region_c=.   
	replace region_c=1 if geo1_py1962==1	/*Concepción*/
	replace region_c=2 if geo1_py1962==2	/*San Pedro*/
	replace region_c=3 if geo1_py1962==3	/*Cordillera*/
	replace region_c=4 if geo1_py1962==4	/*Guaira*/
	replace region_c=5 if geo1_py1962==5	/*Caaguazú*/
	replace region_c=6 if geo1_py1962==6	/*Caazapá*/
	replace region_c=7 if geo1_py1962==7	/*Itapúa*/
	replace region_c=8 if geo1_py1962==8	/*Misiones*/
	replace region_c=9 if geo1_py1962==9	/*Paraguarí*/
	replace region_c=10 if geo1_py1962==10	/*Alto Paraná*/
	replace region_c=11 if geo1_py1962==11	/*Central*/
	replace region_c=12 if geo1_py1962==12	/*Ñembuccú*/
	replace region_c=13 if geo1_py1962==13	/*Amambay*/
*	replace region_c=14 if geo1_py1962==14	/*Canindeyú*/
	replace region_c=15 if geo1_py1962==14	/*Presidente Hayes*/
	replace region_c=16 if geo1_py1962==16	/*Alto Paraguay*/
	replace region_c=17 if geo1_py1962==0	/*Asunción*/
	replace region_c=18 if geo1_py1962==15	/*Olimpo*/
