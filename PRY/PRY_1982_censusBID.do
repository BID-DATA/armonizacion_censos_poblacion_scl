...
*****************************************************
    ...
    ****************
	gen region_c=.   
	replace region_c=1 if geo1_py1982==1	/*Concepción*/
	replace region_c=2 if geo1_py1982==2	/*San Pedro*/
	replace region_c=3 if geo1_py1982==3	/*Cordillera*/
	replace region_c=4 if geo1_py1982==4	/*Guaira*/
	replace region_c=5 if geo1_py1982==5	/*Caaguazú*/
	replace region_c=6 if geo1_py1982==6	/*Caazapá*/
	replace region_c=7 if geo1_py1982==7	/*Itapúa*/
	replace region_c=8 if geo1_py1982==8	/*Misiones*/
	replace region_c=9 if geo1_py1982==9	/*Paraguarí*/
	replace region_c=10 if geo1_py1982==10	/*Alto Paraná*/
	replace region_c=11 if geo1_py1982==11	/*Central*/
	replace region_c=12 if geo1_py1982==12	/*Ñembuccú*/
	replace region_c=13 if geo1_py1982==13	/*Amambay*/
	replace region_c=14 if geo1_py1982==14	/*Canindeyú*/
	replace region_c=15 if geo1_py1982==15	/*Presidente Hayes*/
	replace region_c=16 if geo1_py1982==19	/*Alto Paraguay*/
	replace region_c=17 if geo1_py1982==0	/*Asunción*/
