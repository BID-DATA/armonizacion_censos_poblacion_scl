...
*****************************************************
    ...
    ****************
	gen region_c=.   
replace region_c=1 if geo1_ve1990==1	/*Federal District */
replace region_c=2 if geo1_ve1990==22	/*San Amazonas*/
replace region_c=3 if geo1_ve1990==2	/*Anzoátegui*/
replace region_c=4 if geo1_ve1990==3	/*Apure*/
replace region_c=5 if geo1_ve1990==4	/*Aragua*/
replace region_c=6 if geo1_ve1990==5	/*Barinas*/
replace region_c=7 if geo1_ve1990==6	/*Bolívar*/
replace region_c=8 if geo1_ve1990==7	/*Carabobo*/
replace region_c=9 if geo1_ve1990==8	/*Cojedes*/
replace region_c=10 if geo1_ve1990==23	/*Delta Amacuro*/
replace region_c=11 if geo1_ve1990==9	/*Falcón*/
replace region_c=12 if geo1_ve1990==10	/*Guárico*/
replace region_c=13 if geo1_ve1990==11	/*Lara*/
replace region_c=14 if geo1_ve1990==12	/*Mérida*/
replace region_c=15 if geo1_ve1990==13	/*Miranda*/
replace region_c=16 if geo1_ve1990==14	/*Monagas*/
replace region_c=17 if geo1_ve1990==15	/*Nueva Esparta*/
replace region_c=18 if geo1_ve1990==16	/*Portuguesa*/
replace region_c=19 if geo1_ve1990==17	/*Sucre*/
replace region_c=20 if geo1_ve1990==18	/*Táchira*/
replace region_c=21 if geo1_ve1990==19	/*Trujillo*/
replace region_c=22 if geo1_ve1990==20	/*Yaracuy*/
replace region_c=23 if geo1_ve1990==21	/*Zulia*/
*	replace region_c=24 if geo1_ve1990==24	/*Vargas*/
