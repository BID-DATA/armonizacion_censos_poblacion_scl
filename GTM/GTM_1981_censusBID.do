...
**********************************************	
	...
	if (_rc==0){
		...
		replace desemp_ci=0 if condocup_ci==3 | condocup_ci==1/*0 cuando están inactivos*/
	}
    ...
    replace categopri_ci=3 if classwkd==203 | classwkd==204 | classwkd==216 | classwkd==230 | classwkd==220 | classwkd==200 | classwkd == 210
