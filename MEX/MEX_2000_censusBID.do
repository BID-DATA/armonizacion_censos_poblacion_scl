...
gen region_c =.
replace region_c=1 if geo1_mx2000==1 //
replace region_c=2 if geo1_mx2000==2 //
replace region_c=3 if geo1_mx2000==3 //
replace region_c=4 if geo1_mx2000==4 //
replace region_c=5 if geo1_mx2000==5 //
replace region_c=6 if geo1_mx2000==6 //
replace region_c=7 if geo1_mx2000==7 //
replace region_c=8 if geo1_mx2000==8 //
replace region_c=9 if geo1_mx2000==9 //
replace region_c=10 if geo1_mx2000==10 //
replace region_c=11 if geo1_mx2000==11 //
replace region_c=12 if geo1_mx2000==12 //
replace region_c=13 if geo1_mx2000==13 //
replace region_c=14 if geo1_mx2000==14 //
replace region_c=15 if geo1_mx2000==15 //
replace region_c=16 if geo1_mx2000==16 //
replace region_c=17 if geo1_mx2000==17 //
replace region_c=18 if geo1_mx2000==18 //
replace region_c=19 if geo1_mx2000==19 //
replace region_c=20 if geo1_mx2000==20 //
replace region_c=21 if geo1_mx2000==21 //
replace region_c=22 if geo1_mx2000==22 //
replace region_c=23 if geo1_mx2000==23 //
replace region_c=24 if geo1_mx2000==24 //
replace region_c=25 if geo1_mx2000==25 //
replace region_c=26 if geo1_mx2000==26 //
replace region_c=27 if geo1_mx2000==27 //
replace region_c=28 if geo1_mx2000==28 //
replace region_c=29 if geo1_mx2000==29 //
replace region_c=30 if geo1_mx2000==30 //
replace region_c=31 if geo1_mx2000==31 //
replace region_c=32 if geo1_mx2000==32 //
