...
************************************	
	...
	*********
	...
	replace afro_ci =1 if c5_p25 == 5
	replace afro_ci =0 if c5_p25 != 5 // incluye unkown
	tab afro_ci
	...
	*********	
	...
	replace ind_ci =1 if inrange(c5_p25,1,4) | inrange(c5_p25,10,13)
	replace ind_ci =0 if inrange(c5_p25,5,10) | inrange(c5_p25,13,15) 
	tab ind_ci
